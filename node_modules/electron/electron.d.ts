...
declare namespace Electron {
  ...
  class BrowserWindow extends EventEmitter {
    ...
    /**
     * Specifies whether the window?? document has been edited, and the icon in title
  ...
  interface ClearStorageDataOptions {
    /**
     * Should follow window.location.origin?? representation scheme://host:port.
     */
    origin?: string;
    /**
  ...
  interface Dock {
    ...
    /**
     * Sets the string to be displayed in the dock?? badging area.
     */
